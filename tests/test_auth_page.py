...
def test_catalog_menu_clickable(driver):
   ...
   assert page.get_relative_link() == 'https://www.ozon.ru/category/sumki-zhenskie-17001/'
...
@pytest.mark.skip
@pytest.mark.parametrize('name', ['Помощь', 'Как сделать заказ', 'Доставка'], \
                         ids=['Help', 'How to make', 'Delivery'])
